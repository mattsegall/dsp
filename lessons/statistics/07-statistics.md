...
>> Frequentist inference simpy aims to draw conclusions based on the proportion (frequency) of data observed in sample data, while Bayesian inference attemps to update these coclusions as new evidence (priors) become known.
